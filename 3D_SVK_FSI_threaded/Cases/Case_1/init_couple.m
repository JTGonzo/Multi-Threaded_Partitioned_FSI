...
Couple.lindep = 1e-4;               %| filtering threshold
...
Wid = 98;                              %| watchpoint Id
WidF = 1052;                            %| watchpoint Id
...
switch lower(algorithm)
    ...
    case 'mvls'
        Acc_flag = 8;
        limit = 40;
        model = MVLS(Couple.lindep, limit, Couple.filter, Couple.count, problemString);
    case 'mvlss'
        Acc_flag = 9;
        limit = 40;
        model = MVLSS(Couple.lindep, limit, Couple.filter, Couple.count, problemString);
    otherwise
